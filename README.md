# Available .PLUS One-Word Domains (5,621,931)

<p align="left">
  <img alt="status" src="https://img.shields.io/badge/status-active-2ea44f">
  <img alt="updated" src="https://img.shields.io/badge/updated-daily-0969da">
  <img alt="public extract" src="https://img.shields.io/badge/public%20extract-8%2C422%20rows-8250df">
...
> **Important:** this repository is a **public 8,422-row extract**, not the full live catalog.
> The full live catalog for this exact search currently contains **5,621,931 domains** on the canonical page below.

**Public extract:** 8,422 rows · **Live catalog:** 5,621,931 domains
...
<p align="center">
  ...
  <a href="https://unique.domains/domains/tld/plus?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_plus_oneword_domains&utm_content=top_create_radar"><b>🔔 Create Radar</b></a> ·
  <a href="https://unique.domains/domains/tld/plus?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_plus_oneword_domains&utm_content=top_start_project"><b>🚀 Start a Project</b></a> ·
  <b>⬇️ Download sample</b>: <a href="./plus.csv">CSV</a> / <a href="./plus.json">JSON</a>
</p>

<p align="center">
  <a href="https://unique.domains/technology?utm_source=github&utm_medium=referral&utm_campaign=repo_plus_oneword_domains&utm_content=top_methodology">Methodology</a> ·
  <a href="https://unique.domains/api?utm_source=github&utm_medium=referral&utm_campaign=repo_plus_oneword_domains&utm_content=top_api_docs">API docs</a>
</p>
...
- **Investors:** [Create a Radar from this exact .PLUS search](https://unique.domains/domains/tld/plus?github_intent=radar&utm_source=github&utm_medium=referral&utm_campaign=repo_plus_oneword_domains&utm_content=top_create_radar)
- **Founders:** [Start a Project from this exact .PLUS search](https://unique.domains/domains/tld/plus?github_intent=project&utm_source=github&utm_medium=referral&utm_campaign=repo_plus_oneword_domains&utm_content=top_start_project)
- **Researchers / builders:** [Download CSV](./plus.csv) or [Download JSON](./plus.json)
...
- `plus.csv` — public CSV extract (8,422 rows)
- `plus.json` — public JSON extract (8,422 rows)
...
| ----------------------- | ------------------------------------------------ |
| 8,422-row public sample | 5,621,931 live domains                           |
...
| after.plus     | premium   | $21.99    | $60.99        | 100            | 28     | 5      | name.com                                                |
...
| detroit.plus   | available | $21.99    | —             | 62             | 32     | 7      | name.com                                                |
| boss.plus      | resell    | —         | —             | 76             | 73     | 4      | Alibaba Cloud Computing Ltd. d/b/a HiChina (www.net.cn) |
| vehicle.plus   | premium   | $260      | $260          | 94             | 23     | 7      | namecheap                                               |
...
| trinity.plus   | available | $21.99    | $60.99        | 72             | 31     | 7      | name.com                                                |
...
| habitat.plus   | resell    | —         | —             | 74             | 67     | 7      | Chengdu West Dimension Digital Technology Co., Ltd.     |
...
> Unique Domains. *Available .PLUS One-Word Domains*. Version 2026-04-09. Public GitHub extract for the exact Unique Domains search represented by this repository.
